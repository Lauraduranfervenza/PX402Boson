...
tree.Draw(f'mu_truth_bare_pt>>{data_hist.GetName()}',f'TMath::BreitWigner(V_TRUE_M*1e3,{mass_data},{w_boson_width_mev})/TMath::BreitWigner(V_TRUE_M*1e3,80385.,{w_boson_width_mev})*(Entry$%2==0)','goff')
...
mycanvas.Print("reference_chi.png")
