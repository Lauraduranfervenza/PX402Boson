...
tree.Draw(f'mu_truth_born_pt+mu_truth_leading_photon_pt>>{data_hist.GetName()}',f'TMath::BreitWigner(V_TRUE_M*1e3,{mass_data},{w_boson_width_mev})/TMath::BreitWigner(V_TRUE_M*1e3,80385.,{w_boson_width_mev})*(Entry$%2==0)','goff')
...
c.Print('born_photon_models.png')
...
mycanvas.Print("born_photon_chi.png")
