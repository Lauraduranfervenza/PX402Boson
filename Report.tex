...
\begin{figure}[t!]
\centering
\includegraphics[width=77mm]{muonPTdis.jpg}
\vspace{-2mm}
...
\bibitem{Paper_2} D. Author {\em et al.},
                  Journal {\bf vol}, page (year).
\bibitem{Paper_3} This template was original created by Dirk O. Gericke (Warwick) in 2013 and has been edited by Daniel Brunt (2015) and Robin Ball (2018).
\bibitem{Paper_4} This list of references is the only part of your report allowed to spill beyond 10 pages.
\end{thebibliography}
